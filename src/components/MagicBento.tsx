    ...
    <>
      ...
      <BentoCardGrid gridRef={gridRef}>
        {cards.map((card, index) => {
          const baseClassName = `magic-bento-card ${textAutoHide ? 'magic-bento-card--text-autohide' : ''} ${enableBorderGlow ? 'magic-bento-card--border-glow' : ''} cursor-pointer`;
          const cardProps = {
            ...
            onClick: () => {
              if (card.projectId && onCardClick) {
                onCardClick(card.projectId);
              }
            }
          };
